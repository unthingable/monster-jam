...
case class MonsterPref(
  ...
  fswTip: EnumSetting[JamSettings.SwitchRecord],
  fswRing: EnumSetting[JamSettings.SwitchRecord],
  ...
  override def init(): Unit =
    ...
    ext = MonsterJamExt(
      ...
      MonsterPref(
        ...
        EnumSetting(preferences, "Footswitch tip", "Behavior", JamSettings.SwitchRecord.`Current Clip`),
        EnumSetting(preferences, "Footswitch ring", "Behavior", JamSettings.SwitchRecord.`Current Clip`),
